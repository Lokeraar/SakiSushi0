...
export function mesonerosComponent() {
    return {
        ...
        async agregarMesonero() {
            ...
            try {
                await supabaseClient.client.from('mesoneros').insert([{
        ...
        async guardarMesonero() {
            ...
            try {
                await supabaseClient.client.from('mesoneros').update({
        ...
        async toggleActivo(mesonero) {
            try {
                await supabaseClient.client.from('mesoneros').update({ activo: !mesonero.activo }).eq('id', mesonero.id);
        ...
        async eliminarMesonero(id) {
            ...
            try {
                await supabaseClient.client.from('mesoneros').delete().eq('id', id);
        ...
        async pagarPropinas(mesonero) {
            ...
            try {
                await supabaseClient.client.from('propinas').update({ entregado: true }).in('id', ids);
