...
export function deliverysComponent() {
    return {
        ...
        async agregarDelivery() {
            ...
            try {
                await supabaseClient.client.from('deliverys').insert([{
        ...
        async guardarDelivery() {
            ...
            try {
                await supabaseClient.client.from('deliverys').update({
        ...
        async toggleActivo(delivery) {
            try {
                await supabaseClient.client.from('deliverys').update({ activo: !delivery.activo }).eq('id', delivery.id);
        ...
        async eliminarDelivery(id) {
            ...
            try {
                await supabaseClient.client.from('entregas_delivery').delete().eq('delivery_id', id);
                await supabaseClient.client.from('deliverys').delete().eq('id', id);
        ...
        async registrarPago(delivery) {
            ...
            try {
                await supabaseClient.client.from('entregas_delivery').delete().eq('delivery_id', delivery.id);
