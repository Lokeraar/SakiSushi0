...
(function() {
    ...
    window.toggleTheme = function() {
        ...
        const thumb = document.getElementById('themeIcon');
        if (thumb) thumb.innerHTML = isDark ? '<i class="fas fa-moon"></i>' : '<i class="fas fa-sun"></i>';
    ...
    window.initTheme = function() {
        ...
        if (saved === 'dark') {
            ...
            if (thumb) thumb.innerHTML = '<i class="fas fa-moon"></i>';
        } else {
            document.documentElement.classList.remove('dark-theme');
            if (thumb) thumb.innerHTML = '<i class="fas fa-sun"></i>';
        }
    };
    ...
    window.setupHeader = function() {
        ...
        // El theme toggle ahora es un elemento .theme-toggle-wrap en el HTML.
        // initTheme() ya lo configura al cargar; no hace falta pisar nada aquí.
    };
