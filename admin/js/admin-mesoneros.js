    ...
    window.renderizarMesoneros = async function() {
        ...
        container.innerHTML = sorted.map(m => {
            ...
            return '<div class="card-standard mesonero-card" style="border-left-color:var(--propina)">'
                ...
                +       '<div class="ucard-line2"><span style="font-size:.78rem;color:var(--propina);font-weight:600;text-align:left">Total Acumulado<br>' + window.formatUSD(acumUsd) + ' / ' + window.formatBs(acum) + '</span></div>'
